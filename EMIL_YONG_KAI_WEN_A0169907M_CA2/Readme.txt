...
5)EDRR IDRR BINOMIAL TASK Generator.ipynb ( this is just a separate task generator for binomial , not an algorithm script )
...
10) Key in burst time and arrival time for different arrival
...
16) After setting the file you want, just run all the cell and the result will be printed on the cell output.


You may contact me at +65 9109 9666 or email me at e0191455@u.nus.edu if you faced any difficulty running.
